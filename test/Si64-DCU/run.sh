...
#SBATCH --exclusive
module purge
module add compiler/rocm/dtk/25.04.1 compiler/devtoolset/7.3.1 compiler/intel/2017.5.239 mpi/hpcx/2.11.0/gcc-7.3.1
...
APP=/work1/whu_ustc/yaoyf/soft/dghf-DCU-2025.10.1-25.04/examples/pwdft
