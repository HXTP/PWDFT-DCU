...
mpirun -np 1 -genv UCX_TLS=rc,sm  -genv FI_MPI_FABRICS ofi -genv FI_PROVIDER ucx  -genv UCX_TLS=sm ./intelmpi_bind.sh   /public/home/acents8f17/yaoyf/software/dghf-CPU-2026.1.10/examples/pwdft
